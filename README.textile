...
* UploadHelper::url($data, $field, $style = 'original', $urlize = true)
...
* UploadHelper::image($data, $field, $style = 'original', $options = array())
...
* switch to ImageMagick and allow more customization of method images are thumbnailed with
* allow uploads to S3
