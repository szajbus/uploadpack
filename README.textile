...
<?php echo $upload->image($user, 'User.avatar', 'thumb') ?>
</code></pre>
...
<pre><code><?php echo $upload->image($user, 'User.avatar', 'thumb'); ?></code></pre>
...
<pre><code><?php echo $upload->image($data['User'][0], 'User.avatar', 'thumb') ?></code></pre>
